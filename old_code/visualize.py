...
all_overlapping_pts = np.load("/home/aditya/bcpcr/overlapping_pts_1.0.npy")

# print(all_overlapping_pts)
...
src_ovpts = src[torch.unique(src_ovidx)].squeeze(1)
tgt_ovpts = tgt[torch.unique(tgt_ovidx)].squeeze(1)
...
o3d.visualization.draw_geometries(
    [src_pcd, tgt_pcd, src_ovpts_pcd, tgt_ovpts_pcd],
    zoom=0.7,
