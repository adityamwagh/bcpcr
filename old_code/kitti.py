...
from lib.utils import get_correspondences, to_o3d_pcd
...
class KITTIDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        src_pcd_idx = np.random.choice(src_pcd.shape[0], size=8192, replace=False)
        tgt_pcd_idx = np.random.choice(tgt_pcd.shape[0], size=8192, replace=False)
        return src_pcd[src_pcd_idx], tgt_pcd[tgt_pcd_idx], rot, trans
